            ...
            <div class="space-y-1">
                <div class="flex-1">
                    ...
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        ...
                        <li class="rounded-sm">
                            <Link :href="route('reports')" class="flex items-center p-2 space-x-3 rounded-md">
                        ...
                        <li class="rounded-sm">
                            <Link :href="route('sales')" class="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                        ...
                        <li class="rounded-sm">
                            <Link :href="route('staffs')" class="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
